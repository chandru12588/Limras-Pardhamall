    ...
    <footer className="footer">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="flex justify-center gap-4 mt-4">
          <a href={instagramUrl} target="_blank" rel="noreferrer" className="text-gray-300 hover:text-white inline-flex items-center gap-2">
            <FaInstagram className="text-lg" />
            <span>Instagram</span>
          </a>
          <a href={googleReviewUrl} target="_blank" rel="noreferrer" className="text-gray-300 hover:text-white inline-flex items-center gap-2">
            <FaGoogle className="text-lg" />
            <span>Google Reviews</span>
          </a>
          <a href="https://wa.me/917904559113" target="_blank" rel="noreferrer" className="text-gray-300 hover:text-white inline-flex items-center gap-2">
